...
# This imports some lists - you can ignore this (but don't delete it)
# ------------------------------------------------------------------------------
# Lists of names given to more than 1000 children in the US in the 1990s
...
# print()
# print("Total number of girls names:", ...)
...
# TODO: Change the definition of updated_shortlist so it contains
#       1. all of the names in cat_name_shortlist
#       2. the first three names from girls_names
#       3. the least popular name in girls_names
...
# print()
# print("The alphabetically first unisex name is:", ...)
# print("The alphabetically second last unisex name is:", ...)
# print("All unisex names in reverse alphabetical order:", ...)
...
# print("The first letter of the last rabbit name is", ...)
